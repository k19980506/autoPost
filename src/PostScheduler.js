  ...
  const callAPI = async () => {
    ...
    const promises = scheduleData.map(async (row) => {
      let postData = {
        ...
        url:
          'https://www.star666spa.com/wp-content/uploads/2024/09/' +
          row.photoUrl,
        ...
        access_token:
          'EABnGQiqFBL4BOxtHlaRW8sjIihLdQSv0etHhPSmPgRErXtRZCpjsIGEY4vomgftECCaqDs7f0AWJtwrTaMS6mpFbylNfenAbu1ZAZCKUz1PT2DED62DHsUgCec899tDZCKdBnjZA9JgYScUrYpIXOPnwpJZC3am9z8h5n8AesA8ZBz2ZAia4kZAEypCLtc0I2cehE'
      }

      const response = await fetch(
        `https://graph.facebook.com/v20.0/322730070921865/photos`,
        {
          method: 'POST',
